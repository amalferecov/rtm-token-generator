package com.crag.rtmtoekn.media;
...
public class Utils {
    ...
    public static byte[] pack(com.crag.rtmtoekn.media.PackableEx packableEx) {
        com.crag.rtmtoekn.media.ByteBuf buffer = new com.crag.rtmtoekn.media.ByteBuf();
        packableEx.marshal(buffer);
        return buffer.asBytes();
    }

    public static void unpack(byte[] data, com.crag.rtmtoekn.media.PackableEx packableEx) {
        com.crag.rtmtoekn.media.ByteBuf buffer = new com.crag.rtmtoekn.media.ByteBuf(data);
