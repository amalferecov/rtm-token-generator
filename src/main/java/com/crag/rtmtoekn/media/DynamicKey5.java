...
public class DynamicKey5 {
    ...
    public boolean fromString(String key) {
        ...
        com.crag.rtmtoekn.media.ByteBuf buffer = new com.crag.rtmtoekn.media.ByteBuf(rawContent);
    ...
    static class Message implements Packable {
        ...
        public com.crag.rtmtoekn.media.ByteBuf marshal(com.crag.rtmtoekn.media.ByteBuf out) {
    ...
    public static class DynamicKey5Content implements Packable {
        ...
        public void unmarshall(com.crag.rtmtoekn.media.ByteBuf in) {
